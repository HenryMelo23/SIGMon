...
class SessaoService:
    ...
    def listar_como_monitor(self, id_monitor):
        return self.repo.list_como_monitor(id_monitor)

    def listar_como_estudante(self, id_usuario):
        return self.repo.list_by_estudante(id_usuario)
